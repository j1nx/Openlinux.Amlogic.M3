...
#define PPMGR_CANVAS_INDEX 0xc0
#define PPMGR_DOUBLE_CANVAS_INDEX 0xcf  //for double canvas use
...
#define DI_POST_BUF0_CANVAS_IDX         0x6b
#else
...
#define D2D3_CANVAS_DPG_INDEX      0xDE
#define D2D3_CANVAS_DBR_INDEX      0xDF
