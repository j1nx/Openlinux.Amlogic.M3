...
typedef struct sony_i2c_t {
    ...
    */
    sony_result_t (*Read)(void *pstate,struct sony_i2c_t* pI2c, uint8_t deviceAddress, uint8_t* pData, uint32_t size, uint8_t mode);
    /**
     ...
     @return SONY_RESULT_OK if successful.
    */
    sony_result_t (*Write)(void *pstate,struct sony_i2c_t* pI2c, uint8_t deviceAddress, const uint8_t *pData, uint32_t size, uint8_t mode);
    /**
