...
#define SONY_DVBT2_BW_5_MHZ                            (5)     /**< DVBT2 BW 5MHZ in MHz. */
#define SONY_DVBT2_BW_6_MHZ                            (6)     /**< DVBT2 BW 6MHZ in MHz. */
#define SONY_DVBT2_BW_7_MHZ                            (7)     /**< DVBT2 BW 7MHZ in MHz. */
#define SONY_DVBT2_BW_8_MHZ                            (8)     /**< DVBT2 BW 8MHZ in MHz. */

#define SONY_DVBT2_UNKNOWN_CELLID                    (0)     /**< DVBT2 Unknown CellId */
/* Masks for the tune result for DVB-T2. */
#define SONY_DVBT2_TUNE_RESULT_DATA_PLP_NOT_FOUND  0x02     /**< DVBT2 Data PLP not found indicator. */
...
*/
typedef enum {
    SONY_DVBT2_S1_SISO = 0x00,                              /**< DVBT2 SISO. */
    SONY_DVBT2_S1_MISO = 0x01,                              /**< DVBT2 MISO. */
    ...
    SONY_DVBT2_S1_UNKNOWN = 0xFF                            /**< UNKNOWN DVBT2 MISO/SISO. */
} sony_dvbt2_s1_t;
...
*/
typedef enum {
    SONY_DVBT2_S2_M2K_G_ANY = 0x00,                         /**< DVBT2 2K mode with any guard. */
    SONY_DVBT2_S2_M8K_G_DVBT = 0x01,                        /**< DVBT2 8K mode with DVBT guard. */
    SONY_DVBT2_S2_M4K_G_ANY = 0x02,                         /**< DVBT2 4K mode with any guard. */
    SONY_DVBT2_S2_M1K_G_ANY = 0x03,                         /**< DVBT2 1K mode with any guard. */
    SONY_DVBT2_S2_M16K_G_ANY = 0x04,                        /**< DVBT2 16K mode with any guard. */
    SONY_DVBT2_S2_M32K_G_DVBT = 0x05,                       /**< DVBT2 32K mode with DVBT guard. */
    SONY_DVBT2_S2_M8K_G_DVBT2 = 0x06,                       /**< DVBT2 8K mode with DVBT2 guard. */
    SONY_DVBT2_S2_M32K_G_DVBT2 = 0x07,                      /**< DVBT2 32K mode with DVBT2 guard. */
    SONY_DVBT2_S2_UNKNOWN = 0xFF                            /**< UNKNOWN DVBT2 mode/guard. */
} sony_dvbt2_s2_t;
...
*/
typedef enum {
    SONY_DVBT2_G1_32 = 0x00,                                /**< DVBT2 1/32 GI. */
    SONY_DVBT2_G1_16 = 0x01,                                /**< DVBT2 1/16 GI. */
    SONY_DVBT2_G1_8 = 0x02,                                 /**< DVBT2 1/8 GI. */
    SONY_DVBT2_G1_4 = 0x03,                                 /**< DVBT2 1/4 GI. */
    SONY_DVBT2_G1_128 = 0x04,                               /**< DVBT2 1/128 GI. */
    SONY_DVBT2_G19_128 = 0x05,                              /**< DVBT2 19/128 GI. */
    SONY_DVBT2_G19_256 = 0x06,                              /**< DVBT2 19/256 GI. */
    SONY_DVBT2_G_RSVD1 = 0x07,                              /**< Reserved. */
    SONY_DVBT2_G_UNKNOWN = 0xFF                             /**< UNKNOWN DVBT2 GI. */
} sony_dvbt2_guard_t;
...
*/
typedef enum {
    SONY_DVBT2_M2K = 0x00,                                  /**< DVBT2 2K mode. */
    SONY_DVBT2_M8K = 0x01,                                  /**< DVBT2 8K mode. */
    SONY_DVBT2_M4K = 0x02,                                  /**< DVBT2 4K mode. */
    SONY_DVBT2_M1K = 0x03,                                  /**< DVBT2 1K mode. */
    SONY_DVBT2_M16K = 0x04,                                 /**< DVBT2 16K mode. */
    SONY_DVBT2_M32K = 0x05,                                 /**< DVBT2 32K mode. */
...
*/
typedef enum {
    SONY_DVBT2_BW_8 = 0x00,                                 /**< DVBT2 8MHz. */
    SONY_DVBT2_BW_7 = 0x01,                                 /**< DVBT2 7MHz. */
    SONY_DVBT2_BW_6 = 0x02,                                 /**< DVBT2 6MHz. */
    SONY_DVBT2_BW_5 = 0x03,                                 /**< DVBT2 5MHz. */
    SONY_DVBT2_BW_10 = 0x04,                                /**< DVBT2 10MHz. Professional/Test Receivers Only */
    SONY_DVBT2_BW_1_7 = 0x05,                               /**< DVBT2 1.7MHz. */
    ...
    SONY_DVBT2_BW_UNKNOWN = 0xFF                            /**< DVBT2 Unknown Bandwidth. */
} sony_dvbt2_bw_t;
...
typedef enum {
    ...
    SONY_DVBT2_L1PRE_TYPE_UNKNOWN = 0xFF                    /**< DVBT2 Streams: Unknown. */
...
typedef enum {
    ...
    SONY_DVBT2_PAPR_UNKNOWN = 0xFF                          /**< DVBT2 PAPR Unknown. */
} sony_dvbt2_papr_t;
...
typedef enum {
    ...
    SONY_DVBT2_L1POST_CONSTELL_UNKNOWN = 0xFF               /**< DVBT2 L1-post uses UNKNOWN. */
...
typedef enum {
    ...
    SONY_DVBT2_L1POST_R_UNKNOWN = 0xFF                      /**< DVBT2 L1-post uses UNKNOWN code rate. */
...
typedef enum {
    ...
    SONY_DVBT2_L1POST_FEC_UNKNOWN = 0xFF                    /**< DVBT2 L1-post uses UNKNOWN FEC. */
...
typedef enum {
    ...
    SONY_DVBT2_PP_UNKNOWN = 0xFF                            /**< DVBT2 pilot pattern UNKNOWN. */
} sony_dvbt2_pp_t;
...
*/
typedef enum {
    SONY_DVBT2_R1_2 = 0x00,                                 /**< DVBT2 1/2 code rate. */
    SONY_DVBT2_R3_5 = 0x01,                                 /**< DVBT2 3/5 code rate. */
    SONY_DVBT2_R2_3 = 0x02,                                 /**< DVBT2 2/3 code rate. */
    SONY_DVBT2_R3_4 = 0x03,                                 /**< DVBT2 3/4 code rate. */
    SONY_DVBT2_R4_5 = 0x04,                                 /**< DVBT2 4/5 code rate. */
    SONY_DVBT2_R5_6 = 0x05,                                 /**< DVBT2 5/6 code rate. */
    SONY_DVBT2_R_RSVD1 = 0x06,                              /**< Reserved. */
    SONY_DVBT2_R_RSVD2 = 0x07,                              /**< Reserved. */
    SONY_DVBT2_PLP_CR_UNKNOWN = 0xFF                        /**< UNKNOWN DVBT2 PLP code rate. */
...
*/
typedef enum {
    SONY_DVBT2_QPSK = 0x00,                                 /**< DVBT2 QPSK. */
    SONY_DVBT2_QAM16 = 0x01,                                /**< DVBT2 QAM16. */
    SONY_DVBT2_QAM64 = 0x02,                                /**< DVBT2 QAM64. */
    SONY_DVBT2_QAM256 = 0x03,                               /**< DVBT2 QAM256. */
    ...
    SONY_DVBT2_CONSTELL_UNKNOWN = 0xFF                      /**< UNKNOWN DVBT2 constellation. */
...
*/
typedef enum {
    SONY_DVBT2_FEC_LDPC_16K = 0x00,                         /**< DVBT2 LDPC 16K (Short FECFRAME). */
    SONY_DVBT2_FEC_LDPC_64K = 0x01,                         /**< DVBT2 LDPC 64K (Long FECFRAME). */
...
typedef struct sony_dvbt2_plp_t {
    ...
    */
    ...
    /**
     @brief ISSY indicator. 1 = ISSY enabled. 0 = disabled
    */
    uint8_t issy;

    /**
     @brief Null packet detection indicator. 1 = enabled. 0 = disabled
    */
    uint8_t npd;

    /**
     @brief PLP Mode. 1 = HEM. 0 = Normal
    */
    uint8_t plpMode;
    ...
    */
    ...
    /**
     @brief In band B signalling indicator. 1 = enabled. 0 = disabled
    */
    uint8_t inBandBFlag;
...
*/
typedef struct sony_dvbt2_tune_params_t {
