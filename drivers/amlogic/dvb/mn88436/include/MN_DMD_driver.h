...
/*! Lock Status */
typedef enum _DMD_LOCK_STATUS_t{
	DMD_E_LOCKED = 0,
	DMD_E_LOCK_NOSIGNAL,
	DMD_E_LOCK_NOSYNC,
	DMD_E_LOCK_ERROR
...
typedef enum _DMD_ERROR_t{
	DMD_E_OK    = 0,
	DMD_E_ERROR = 1
} DMD_ERROR_t;

/*! BAND WIDTH */
typedef enum _DMD_BANDWIDTH_t{
...
extern DMD_u32_t DMD_API DMD_open			( DMD_PARAMETER* param);
extern DMD_u32_t DMD_API DMD_set_devid	( DMD_PARAMETER* param , DMD_u32_t id);
extern DMD_u32_t DMD_API DMD_init			( DMD_PARAMETER* param);
extern DMD_u32_t DMD_API DMD_set_system	( DMD_PARAMETER* param );
extern DMD_u32_t DMD_API DMD_tune			( DMD_PARAMETER* param);
extern DMD_u32_t DMD_API DMD_scan			( DMD_PARAMETER* param);
extern DMD_u32_t DMD_API DMD_reset		( DMD_PARAMETER* param);
extern DMD_u32_t DMD_API DMD_term			( DMD_PARAMETER* param);
extern DMD_u32_t DMD_API DMD_get_info		( DMD_PARAMETER* param , DMD_u32_t id );
extern DMD_u32_t DMD_API DMD_set_info		( DMD_PARAMETER* param , DMD_u32_t id , DMD_u32_t val);
extern DMD_u32_t DMD_API DMD_close		( DMD_PARAMETER* param);

/* Floating Functions */
// To use  , define DMD_FLOATING_FUNCTION
extern DMD_float_t DMD_API DMD_get_ber( DMD_PARAMETER* param );
extern DMD_float_t DMD_API DMD_get_per( DMD_PARAMETER* param );
extern DMD_float_t DMD_API DMD_get_cnr( DMD_PARAMETER* param );
...
extern DMD_text_t DMD_API DMD_value_text( DMD_PARAMETER* param , DMD_u32_t id );

/* **************************************************** */
/* DMD Information */
/* **************************************************** */
/*! common information enum */
typedef	enum	_DMD_INFO_t{	DMD_E_INFO_ALL	=0	,	
			DMD_E_INFO_REGREV	=1	,	
...
typedef	enum	_DMD_INFO_DVBT_t{	DMD_E_INFO_DVBT_ALL	=0	,	
...
typedef	enum	_DMD_INFO_DVBT2_t{	DMD_E_INFO_DVBT2_ALL	=0	,	
