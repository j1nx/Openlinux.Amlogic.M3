...
void power_gate_init(void)
{
	...
	/*gate off as possible  as it can in m3 dongle*/
  ...
  //  GATE_OFF(AMRISC);
   ...
   // GATE_OFF(VI_CORE);
	...
	//GATE_OFF(SPI2);
    //GATE_OFF(MDEC_CLK_ASSIST);
    //GATE_OFF(MDEC_CLK_PSC);
    //GATE_OFF(SPI1);
    GATE_OFF(AUD_IN);
    GATE_OFF(ETHERNET);
    //GATE_OFF(DEMUX);
  ...
  //  GATE_OFF(BLK_MOV);
    ...
    //GATE_OFF(RESET);
    //GATE_OFF(NAND);
   // GATE_OFF(HIU_PARSER_TOP);
   // GATE_OFF(MDEC_CLK_DBLK);
  ...
  //  GATE_OFF(HDMI_PCLK);
   // GATE_OFF(MISC_USB1_TO_DDR);
   // GATE_OFF(MISC_USB0_TO_DDR);
   // GATE_OFF(AIU_PCLK);
   // GATE_OFF(MMC_PCLK);
   // GATE_OFF(MISC_DVIN);
   // GATE_OFF(MISC_RDMA);
